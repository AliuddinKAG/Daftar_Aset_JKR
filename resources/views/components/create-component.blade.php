...
$(document).ready(function() {
    ...
    $('.select2-blok, .select2-aras, .select2-ruang, .select2-nama-ruang').select2({
        theme: 'bootstrap-5',
        tags: true,
