<div class="page-wrapper" style="padding: 8mm; font-size: 8pt; line-height: 1.0; transform: scale(0.85); transform-origin: top center;">
    ...
    <div class="page-header" style="border-bottom: 2px solid #fff; padding-bottom: 2px;">
        ...
        <h2>Peringkat Sub Komponen @if(isset($index) && isset($total))({{ $index }}/{{ $total }})@endif</h2>
    </div>
    ...
    <div style="margin-top: 4px; margin-bottom: 3px;">
        ...
        <div style="margin-bottom: 2px; font-size: 7.4pt;">
            ...
            <span style="border-bottom: 1px solid #000; display: inline-block; width: calc(100% - 200px); min-height: 12px; padding-left: 5px;">
        ...
        <div style="font-size: 7.4pt;">
            ...
            <span style="border-bottom: 1px solid #000; display: inline-block; width: 200px; min-height: 12px; padding-left: 5px;">
                {{ $subComponent->mainComponent->id ?? '' }}
            </span>
            
            <span style="margin-left: 40px;">Kod Lokasi</span>
            <span style="margin: 0 5px;">:</span>
            <span style="border-bottom: 1px solid #000; display: inline-block; width: calc(100% - 450px); min-height: 12px; padding-left: 5px;">
                {{ $subComponent->mainComponent->kod_lokasi ?? '' }}
            </span>
        </div>
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="1"><span>(Panjang/Tinggi/Lebar/Luas/Dalam/Lebar/Tebal/Diameter/Jarak dll)</span></td>
        ...
        <tr>
            <td colspan="7" style="min-height: 15px;">
                <strong>Catatan:</strong> {{ $subComponent->catatan_atribut ?? '' }}
            </td>
        </tr>
        ...
        <tr>
            <td colspan="7" style="min-height: 15px;">
                <strong>Catatan:</strong> {{ $subComponent->catatan_pembelian ?? '' }}
            </td>
        </tr>
