                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="status_komponen">
                                                ...
                                                <option value="operational" {{ old('status_komponen', $subComponent->status_komponen) == 'operational' ? 'selected' : '' }}>Beroperasi</option>
                                                <option value="under_maintenance" {{ old('status_komponen', $subComponent->status_komponen) == 'under_maintenance' ? 'selected' : '' }}>Sedang Diselenggara</option>
