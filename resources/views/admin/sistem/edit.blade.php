...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- Header -->
            <div class="mb-4">
                <h2 class="mb-1"><i class="bi bi-pencil"></i> Edit Sistem</h2>
            ...
            <form action="{{ route('admin.sistem.update', $sistem) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kod" class="form-control @error('kod') is-invalid @enderror" 
                                       value="{{ old('kod', $sistem->kod) }}" required placeholder="Contoh: HVAC">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" 
                                           {{ old('is_active', $sistem->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" 
                                       value="{{ old('nama', $sistem->nama) }}" required placeholder="Contoh: Sistem Penghawa Dingin dan Pengudaraan">
                                @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" 
                                          rows="4" placeholder="Masukkan keterangan sistem (opsional)">{{ old('keterangan', $sistem->keterangan) }}</textarea>
                                @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="d-flex gap-2 mb-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Kemaskini Sistem
                    </button>
